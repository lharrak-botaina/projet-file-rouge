            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <!-- form -->
                        <div class="card-header">Ajouter ingredient </div>
                        <div class="card-body">

                            
                                <form action="{{route('afficher-ingredient.store')}}" enctype="multipart/form-data"
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group ">
                                                ...
                                                <input id="cc-exp" name="name_ingredient" type="text"
                                        ...
                                        <div class="col-6">
                                            <div class="form-group ">
                                                ...
                                                <input id="cc-exp" name="photo_ingredient" type="file"
                                                    class="form-control cc-exp" value="" data-val="true"
                                                    data-val-required="Please enter the card expiration"
                                                    data-val-cc-exp="Please enter a valid month and year"
                                                    autocomplete="cc-exp">
