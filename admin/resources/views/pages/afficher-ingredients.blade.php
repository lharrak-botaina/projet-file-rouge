...
<body>
  <div class="wrapper">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12">
            <span class="pagetitle__subheading">Get new recipe</span>
            <h1 class="pagetitle__heading">Select your ingredients</h1>
          </div><!-- /.col-lg-12 -->
        </div><!-- /.row -->
      </div><!-- /.container -->
    </section><!-- /.page-title -->
    ...
    <section id="contact" class="contact">
                      ...
                      <div class="card">
                        <div class="card-body text-center">
                          <div class="imag_categorie">
                            <img src="assets/images/categorie/diet.png" alt="">
          ...
          <div>
            <button id="button"> <a class="btn btn__primary btn__bordered btn__lg">Find your recipes</a></button>
          </div>
        </form>
            ...
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="footer__copyright mb-30">
                  ...
                  <a  class="color-theme">lharrak botaina</a>
                </div>
