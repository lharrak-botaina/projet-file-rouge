        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="mainNavigation">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav__item with-dropdown">
                <li class="nav__item" ><a   class="nav__item-link">Home </a></li>
              </li><!-- /.nav-item -->
              <li class="nav__item with-dropdown">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12">
            <div class="alert-panel d-flex align-items-center justify-content-between">
              <div class="alert__content">
                <h6 class="alert__title">how to prepare an omelet.</h6>
              </div><!-- /.alert__content-->
        ...
        <div class="row">
          <div class="col-sm-12 col-md-6 col-lg-6">
            <div class="product__single-img">
              <img src="assets/images/shop/full/Omlet.jfif" class="zoomin" alt="product">
            </div><!-- /.product-img -->
          </div><!-- /.col-lg-6 -->
          {{-- @forelse ($data as $item) --}}
          <div class="col-sm-12 col-md-6 col-lg-6">
            {{-- <h4 class="product__title">{{$item->nom_recette}}</h4> --}}
            <h4 class="product__title">Omelet</h4>
