                                    ...
                                    <div class="col-xl-6 col-lg-12 col-md-12">
                                        ...
                                        <form method="POST" action="{{route('afficher-endroit.update',$value->id_places)}}" enctype='multipart/form-data'
                                            ...
                                            <div class="col-6">
                                                ...
                                                <option selected value="{{$value->id_ingredient}}">{{$value->name_ingredient}}</option>
                                                
                                                @forelse ($ingredient as $valuee)
                                                     
                                                    
                                                  <option value="{{$valuee->id_ingredient}}">{{$valuee->name_ingredient}} </option>
